...
```bash
# 可选：自行编译安装：
$ git clone https://github.com/tensionc/goctl-swagger.git
$ cd goctl-swagger
$ go install

# 推荐：使用如下命令安装：
$ go install github.com/tensionc/goctl-swagger@latest
```

或者从 github 的 [release](https://github.com/tensionc/goctl-swagger/releases) 页面下载预编译好的二进制文件
